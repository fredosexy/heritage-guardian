...
('00000000-0000-0000-8000-000000000000','b3000000-0000-4000-8000-000000000003','authenticated','authenticated','b3-other@example.test','',now(),'{}','{"full_name":"Other"}',now(),now());
